...
import GenSkbayby from "./ver2/page/GenSkbayby";
import GenImg from "./ver2/page/GenImg";
import GenVideo from "./ver2/page/GenVideo";
import AboutCompany from "./ver2/page/AboutCompany";
import PrivateRoute from "./ver2/routes/PrivateRoute";
      ...
      <Routes>
        <Route path="" element={<LayoutGuest />}>
          ...
          <Route element={<PrivateRoute user={user} />}>
            ...
            <Route path="gensk" element={<GenSkbayby />} />
            <Route path="genimg" element={<GenImg />} />
            <Route path="genvideo" element={<GenVideo />} />
          </Route>
        </Route>
