      ...
      <main>
        ...
        <div className="p-4 overflow-y-scroll w-full about_p">
          ...
          <p class="text-3xl leading-7 ">
            ...
            This Privacy Notice is designed to help you understand how Thinkdiff, a company duly incorporated under the Vietnam, which principal place of business is Ha Noi VietNam (“we,” “us,” and “our”) collects, uses, and shares your personal information and to help you understand and exercise your privacy rights.

            <br />
            <h3 className="pt-5 text-5xl font-semibold ">CONTENT</h3>
            <br />
            <ol className="text-blue-500">
              ...
              <li>
                <a href="#changes">2. Changes to our privacy notice</a>
              </li>
              <li>
                <a href="#3">3. Personal information we collect</a>
              </li>
              <li>
                <a href="#4">4. How we use your information</a>
              </li>
              <li>
                <a href="#5">5. How we disclose your information</a>
              </li>
              <li>
                <a href="#6">6. Your privacy choices and rights</a>
              </li>
              <li>
                <a href="#7">7. Security of your information</a>
              </li>
              <li>
                <a href="#8">8. International data transfers</a>
              </li>
              <li>
                <a href="#9">9. Retention of personal information</a>
              </li>
              <li>
                <a href="#10">10. Supplemental notice for California residents</a>
              </li>
              <li>
                <a href="#11">11. Supplemental notice for Nevada residents</a>
              </li>
              <li>
                <a href="#12">12. Children’s information</a>
              </li>
              <li>
                <a href="#13">13. Third-party websites/applications</a>
              </li>
              <li>
                <a href="#14">14. Supervisory authority</a>
                
              </li>
              <li>
                <a href="#15">15. WHAT face data does your app collect?</a>
              </li>
              <li>
                <a href="#16">16. How do you use the collected face data? Provide a complete and clear explanation of all planned uses of this data.</a>
              </li>
              <li>
                <a href="#17">17. Will the data be shared with any third parties? Where will this information be stored?Ï</a>
                
              </li>
              <li>
                <a href="#18">18. How long will face data be retained?</a>
              </li>
              <li>
            ...
            <br />
            <h3 className="pt-5 text-5xl font-semibold ">
              <a id="scope">1 SCOPE</a>
            </h3>
            <br />
            ...
            <h3 className="text-5xl font-semibold ">
              <a id="changes">2. CHANGES TO OUR PRIVACY NOTICE</a>
            </h3>
            <br />
            ...
            <br />
            <h3 className="text-5xl font-semibold ">
              <a id="3">3. PERSONAL INFORMATION WE COLLECT</a></h3>
            <br />
            The categories of personal information we collect depend on how you interact with us, our Services and the requirements of applicable law. We collect information that you provide to us, information we obtain automatically when you use our Services, and information from other sources such as third-party services and organizations, as described below.

            <br />
            <h3 className="text-5xl font-semibold ">3.1. Information You Provide to Us Directly</h3>
            <br />
            We may collect the following personal information that you provide to us.

            <ol>
              <li>(a) Biometric Data. Subject to your separate opt-in consent, we may collect biometric data from you including photos and videos of your face, including your facial geometry. You may opt out of our use of this data at any time by contacting us at the contact information provided below in Section 15.</li>

              <li>(b) Interactive Features. We and others who use our Services may collect personal information that you submit or make available through our interactive features (e.g., the content that you share and social media pages). Any information you provide on the public sections of these features will be considered “public,” unless otherwise required by applicable law, and is not subject to the privacy protections referenced herein.</li>

              <li>(c) Purchases. As soon as FutureLove allows any purchases, we may collect personal information and details associated with your purchases, including payment information. In some cases, you may need to provide us with additional information to verify your identity before completing a transaction. Any payments made via our Services are processed by third-party payment processors. We do not directly collect or store any payment card information entered through our Services, but we may receive information associated with your payment card information (e.g., your billing details).</li>

              <li>(d) Your Communications with Us. We may collect personal information, such as email address and phone number when you request information about our Services, register to receive our newsletter or marketing, request customer or technical support, or otherwise communicate with us.</li>

              <li>(e) Surveys. We may contact you to participate in the surveys. If you decide to participate, you may be asked to provide certain information which may include personal information.</li>

              <li>(f) Sweepstakes or Contests. We may collect personal information you provide for any sweepstakes or contests that we offer. In some jurisdictions, we are required to publicly share information of sweepstakes and contest winners.</li>
            </ol>
            ...
            <ul>
              ...
              <li>i. Cookies. Cookies are small text files placed in device browsers that store preferences and facilitate and enhance your experience.
              </li>
              <li>ii. Pixel Tags/Web Beacons. A pixel tag (also known as a web beacon) is a piece of code embedded in our Services that collects information about engagement on our Services. The use of a pixel tag allows us to record, for example, that a user has visited a particular web page or clicked on a particular advertisement. We may also include web beacons in e-mails to understand whether messages have been opened, acted on, or forwarded.</li>
            </ul>
            Our use of these Technologies fall into the following general categories:

            <br />
            <ul>
              <li>• Operationally Necessary. This includes Technologies that allow you access to our Services, applications, and tools that are required to identify irregular website behavior, prevent fraudulent activity and improve security or that allow you to make use of our functionality;
              ...
              <li>• Functionality-Related. We may use Technologies that allow us to offer you enhanced functionality when accessing or using our Services. This may include identifying you when you sign into our Services or keeping track of your specified preferences, interests, or past items viewed;

              </li>
              <li>• Advertising- or Targeting-Related. We may use first party or third-party Technologies to deliver content, including ads relevant to your interests, on our Services or on third-party websites.
            ...
            <br />
            <h3 className="text-5xl font-semibold ">
            <a id="4">4. HOW WE USE YOUR INFORMATION</a>
            ...
            <ol>
              <li>
                <strong>4.1 Provide Our Services</strong>
                <p>We use your information to fulfill our contract with you and provide you with our Services, such as:</p>
                <ol type="a">
                  <li>Providing face(-s) animation on a photo or a picture features, and other similar Services;</li>
                  ...
                  <li>Communicating with you about your account, activities on our Services, and policy changes; and</li>
                  <li>Processing your financial information and other payment methods for products or Services purchased.</li>
                </ol>
              </li>
              <li>
                <strong>4.2 Administrative Purposes</strong>
            ...
            <ol>
              <li>
                <strong>4.3 Marketing and Advertising our Products and Services</strong>
                ...
                <p>If you have any questions about our marketing practices or if you would like to opt out of the use of your personal information for marketing purposes, you may contact us at any time as set forth in Section 15 below.</p>
              </li>
              <li>
                <strong>4.4 Other Purposes</strong>
                ...
                <ol type="a">
                  ...
                  <li>
                    ...
                    <p>We may use personal information and other information about you to create de-identified and/or aggregated information, such as de-identified demographic information, de-identified location information, information about the device from which you access our Services, or other analyses we create.</p>
                  </li>
                  <li>
                    <strong>Share Content with Friends or Colleagues.</strong>
                    <p>Our Services may offer various tools and functionalities. For example, we may allow you to provide information about your friends or colleagues through our referral services. Our referral services may allow you to forward or share certain content with a friend or colleague, such as an email inviting your friend to use our Services.</p>
                  </li>
                </ol>
              </li>
            </ol>
            ...
            <h3 className="text-5xl font-semibold ">
              ...
              <a id="5">5. HOW WE DISCLOSE YOUR INFORMATION</a>
            ...
            <ol start="5" type="1">
              <li>
                <strong>5.1 Disclosures to Provide our Services</strong>
                <p>The categories of third parties with whom we may share your information are described below.</p>
                <ol type="a">
                  <li>
                    <strong>a Other Users or Third Parties.</strong>
                    <p>When you use the Services, you may choose to share personal information or content with other users or third parties. In addition, certain aspects of your profile may be available to other users.</p>
                  </li>
                  <li>
                    <strong>b Service Providers.</strong>
                    <p>We may share your personal information with our third-party service providers who use that information to help us provide our Services. This includes service providers that provide us with IT support, hosting, payment processing, customer service, and related services.</p>
                  </li>
                  <li>
                    <strong>c Business Partners.</strong>
                    <p>We may share your personal information with business partners to provide you with a product or service you have requested. We may also share your personal information with business partners with whom we jointly offer products or services.</p>
                  </li>
                  <li>
                    <strong>d Advertising Partners.</strong>
                    <p>We may share your personal information, except for your biometric data, with third-party advertising partners. These third-party advertising partners may set Technologies and other tracking tools on our Services to collect information regarding your activities and your device (e.g., your IP address, cookie identifiers, page(s) visited, location, time of day). These advertising partners may use this information (and similar information collected from other services) for purposes of delivering personalized advertisements to you when you visit digital properties within their networks. This practice is commonly referred to as “interest-based advertising” or “personalized advertising.”</p>
                  </li>
                  <li>
                    <strong>e APIs/SDKs.</strong>
                    <p>We may use third-party application program interfaces (“APIs”) and software development kits (“SDKs”) as part of the functionality of our Services. For more information about our use of APIs and SDKs, please contact us as set forth below.</p>
                  </li>
                </ol>
              </li>
              <li>
                <strong>5.2 Disclosures to Protect Us or Others</strong>
            ...
            <h3 className="text-5xl font-semibold ">
              ...
              <a id="6">6. YOUR PRIVACY CHOICES AND RIGHTS</a>
            </h3>
            <br />
            <p>
              <strong>6.1. Your Privacy Choices</strong>
              ...
              <ol type="a">
                <li>
                  <strong>(a) Email Communications.</strong>
                  <p>If you receive an unwanted email from us, you can use the unsubscribe link found at the bottom of the email to opt out of receiving future emails. Note that you will continue to receive transaction-related emails regarding products or Services you have requested. We may also send you certain non-promotional communications regarding us and our Services, and you will not be able to opt out of those communications (e.g., communications regarding our Services or updates to our Terms of Use or this Privacy Notice).</p>
                </li>
                <li>
                  <strong>(b) Text Messages.</strong>
                  <p>You may opt out of receiving text messages from us by following the instructions in the text message you have received from us or by otherwise contacting us.</p>
                </li>
                <li>
                  <strong>(c) Mobile Devices.</strong>
                  <p>We may send you push notifications through our mobile app. You may opt out from receiving these push notifications by changing the settings on your mobile device. With your consent, we may also collect precise location-based information via our mobile app. You may opt out of this collection by changing the settings on your mobile device.</p>
                </li>
                <li>
                  <strong>(d) “Do Not Track.”</strong>
            ...
            <h3 className="text-5xl font-semibold ">
              ...
              <a id="7">7. SECURITY OF YOUR INFORMATION</a>
            ...
            <h3 className="text-5xl font-semibold ">
              ...
              <a id="8">8. INTERNATIONAL DATA TRANSFERS</a>
            </h3>
            <br />
            <p>
              Many of our external third parties are based outside the UK so their processing of your personal data will involve a transfer of data outside the UK. We may transfer your personal data to our group companies that are located outside the UK, including, but not limited, in the United States, or other countries, which may have data protection laws that are different from the laws where you live.
            ...
            <h3 className="text-5xl font-semibold ">
              ...
              <a id="9">9. RETENTION OF PERSONAL INFORMATION</a>
            </h3>
            <br />
            <p>
            ...
            <h3 className="text-5xl font-semibold ">
              ...
              <a id="10">10. SUPPLEMENTAL NOTICE FOR CALIFORNIA RESIDENTS</a>
            </h3>
            <br />
            ...
            <ol type="1">
              <li>
                <strong>Category of Personal Information Collected by Company</strong>
                <ul>
                  <li>Identifiers</li>
                  <li>Personal information categories listed in Cal. Civ. Code § 1798.80(e)</li>
                  ...
                  <li>Inferences drawn from other personal information to create a profile about a consumer</li>
                </ul>
              </li>
              <li>
                <strong>Categories of Third Parties Personal Information is Disclosed to for a Business Purpose</strong>
                <ul>
                  <li>Service providers</li>
                  <li>Other users or third parties you share with</li>
            ...
            <p>If you are a California resident and would like to exercise any of your rights under the CCPA, please contact us as set forth in Section 15 below. We will process such requests in accordance with applicable laws.</p>
            <br />
            <h3 className="text-5xl font-semibold ">
              
              <a id="11">11. SUPPLEMENTAL NOTICE FOR NEVADA RESIDENTS</a>
            ...
            <h3 className="text-5xl font-semibold ">
              ...
              <a id="12">12. CHILDREN’S INFORMATION</a>
            ...
            <h3 className="text-5xl font-semibold ">
              ...
              <a id="13">13. THIRD-PARTY WEBSITES/APPLICATIONS</a>
            </h3>
            <br />
            <p>
            ...
            <h3 className="text-5xl font-semibold ">
              ...
              <a id="14">14. SUPERVISORY AUTHORITY</a>
            ...
            <h3 className="text-5xl font-semibold ">
              ...
              <a id="15">15. WHAT face data does your app collect?</a>
            </h3>
            <br />
            <p>
              ⇒ Our application takes a photo of a face without makeup, without glasses,
              without a mask. Our application will take a photo of a man and 1 photo of a woman to create a pairing event.
              Take a look at our running results here:
              <a style={{ color: "blue" }} href="https://futurelove.online/detail/920980354218/1">https://futurelove.online/detail/920980354218/1 </a>

            </p>
            <br />
            <h3 className="text-5xl font-semibold ">
            <a id="16">16. How do you use the collected face data? Provide a complete and clear explanation of all planned uses of this data.</a>
            ...
            <h3 className="text-5xl font-semibold ">
              ...
              <a id="17">17. Will the data be shared with any third parties? Where will this information be stored?</a>
            </h3>
            <br />
            <p>
            ...
            <h3 className="text-5xl font-semibold ">
              ...
              <a id="18"> 18. How long will face data be retained?</a>
            </h3>
            <br />
            <p>
