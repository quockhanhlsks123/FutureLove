...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      usernameupdate(userInfo.username);
      passwordupdate(userInfo.password);
    }
  }, []);
  ...
  const handleGoogleLogin = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.get("https://metatechvn.store/login/user", {
        withCredentials: true,
      });
      console.log(response.data);
      // Xử lý kết quả và thực hiện các hành động khác nếu cần
    } catch (error) {
  ...
  const ProceedLogin = async (e) => {
    ...
    if (validate()) {
      try {
        ...
        return toast.error(
          "Password Wrong Or Account Not Register Or Account Not Verify Email"
        );
      } finally {
        isLoading(false);
      }
        ...
        >
          ...
          <div className="w-[40%] h-[100%]">
            <div className="bg-gradient-to-r from-slate-900 to-slate-500 w-[100%] h-[100%] z-30 opacity-75 flex">
              <form className="z-40">
                <div className="flex flex-col items-center mx-16 text-center">
                  ...
                  <div className="mt-10">
                    ...
                    <button
                      className="px-4 py-2 font-bold text-white bg-blue-600 rounded focus:outline-none focus:shadow-outline-blue active:bg-blue-800"
        ...
        >
          <div className="">
            <div className="flex flex-col items-center mx-7">
              ...
              >
                {loading ? (
                  <div role="status" className="flex justify-center px-5 py-3">
                    <svg
                      aria-hidden="true"
              ...
              >
                ...
                <span className="mt-2 text-xl text-white">Back</span>
              </button>
            </div>
          </div>
        </div>
